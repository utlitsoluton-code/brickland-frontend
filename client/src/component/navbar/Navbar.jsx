...
// export default function Navbar() {
//   return (
//     <Disclosure as="nav" className="shadow-lg z-20" style={{ background: "var(--white)", position: "sticky", top: 0 }}>
//       {({ open }) => (
//         <>
//           <div className="mx-auto max-w-9xl px-2 sm:px-6 lg:px-8 ml-0">
//             <div className="relative flex h-16 items-center justify-between">
...
//                   <span className="sr-only">Open main menu</span>
//                   {open ? (
//                     <XMarkIcon className="block h-6 w-6 " aria-hidden="true" style={{ color: "black" }} />
//                   ) : (
//                     <Bars3Icon className="block h-6 w-6" aria-hidden="true" style={{ color: "black" }} />
//                   )}
//                 </Disclosure.Button>
//               </div>
//               <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start w-full">
...
//                     src="https://firebasestorage.googleapis.com/v0/b/real-estate-3a526.appspot.com/o/Brickland-Consulting-Logo.png?alt=media&token=5a20be0a-5015-4a13-9d78-e7f68faddd39"
//                     alt="Your Company"
//                   />
//                   </Link>
//                 </div>
...
//                         to={item.path}
//                         className={classNames(
//                           item.current ? 'bg-yellow-400 text-black hover:bg-green-400 hover:text-white' : 'text-black hover:bg-gray-700 hover:text-white',
//                           'rounded-md px-3 py-2 text-sm font-medium'
//                         )}
//                         aria-current={item.current ? 'page' : undefined}>
//                         {item.name}
