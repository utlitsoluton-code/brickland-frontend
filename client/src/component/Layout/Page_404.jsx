            ...
            <div className="grid grid-cols-1  text-center justify-center sm:grid-cols-2">
                <div className="mt-20">
                    <div className="text-center justify-center flex">
                        {/* <img src={} alt="logo" className='h-40 w-40 ' /> */}
                    </div>
                    <div className="grid grid-cols-1">
                        ...
                        <div className="flex items-center justify-center text-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
                            ...
                            <Link to='/profile'><button className="px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                                Take me home
                            </button></Link>
                        </div>
                    </div>
