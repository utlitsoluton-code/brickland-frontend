...
const City = () => {
  ...
  return (
    <div>
      ...
      <div className="category-area pb-95">
    ...
    >
      ...
      >
        <div className="category-box">
          <div className="image">
            <img src="assets/images/category/category9.png" alt="image" />
          </div>
          <div className="content">
            <h3>
              <a href="property-grid.html">Town House</a>
            </h3>
      ...
      >
        <div className="category-box">
          <div className="image">
            <img src="assets/images/category/category10.png" alt="image" />
          </div>
          <div className="content">
            <h3>
      ...
      >
        <div className="category-box">
          <div className="image">
            <img src="assets/images/category/category11.png" alt="image" />
          </div>
          <div className="content">
            <h3>
      ...
      >
        <div className="category-box">
          <div className="image">
            <img src="assets/images/category/category12.png" alt="image" />
          </div>
          <div className="content">
            <h3>
      ...
      >
        <div className="category-box">
          <div className="image">
            <img src="assets/images/category/category13.png" alt="image" />
          </div>
          <div className="content">
            <h3>
              <a href="property-grid.html">Luxury Estate</a>
            </h3>
            <span>(78 Properties)</span>
          </div>
        </div>
      </div>
      <div
      ...
      >
        <div className="category-box">
          <div className="image">
            <img src="assets/images/category/category14.png" alt="image" />
          </div>
          <div className="content">
            <h3>
